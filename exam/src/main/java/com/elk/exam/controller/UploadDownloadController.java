...
import com.elk.exam.common.utils.FileTransUtil;
import com.elk.exam.dto.DownloadDTO;
import com.elk.exam.dto.UploadModel;
import com.elk.exam.dto.UploadModel2;
...
/**
 * 文件上传下载的接口,由于Swagger的问题导致在SwaggerUI里测试不成功，实际上前端是完全没有问题的
...
//    }
    ...
    public ResponseEntity<InputStreamResource> downloadFilePost(@RequestBody DownloadDTO downloadDTO) throws IOException {
        return FileTransUtil.downloadFile(downloadDTO.getPath());
    }
}
